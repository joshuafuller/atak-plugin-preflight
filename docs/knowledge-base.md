...
| Fortify source SAST | Semgrep Community Edition and focused secure-coding rules | Matching source patterns/data flow; not Fortify parity |
| Dependency advisories | OSV-Scanner, Trivy, and optionally OWASP Dependency-Check | Recognized coordinates and files; tool coverage is incomplete |
